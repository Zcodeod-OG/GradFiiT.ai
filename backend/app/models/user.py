...
class User(Base):
    ...
    avatar_source_image_url = Column(Text, nullable=True)
    avatar_model_id = Column(String, nullable=True)
    avatar_model_url = Column(Text, nullable=True)
    avatar_preview_url = Column(Text, nullable=True)
    avatar_turntable_url = Column(Text, nullable=True)
    ...
    default_person_image_url = Column(Text, nullable=True)
    default_person_image_s3_key = Column(Text, nullable=True)
    default_person_smart_crop_url = Column(Text, nullable=True)
    default_person_face_url = Column(Text, nullable=True)
